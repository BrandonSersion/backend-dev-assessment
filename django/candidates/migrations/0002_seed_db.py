...
def seed_db(apps, schema_editor):
    ...
    Candidate.objects.get_or_create(
        ...
        years_exp=10,
        status='pending',
        date_applied=datetime(2018, 6, 5, 11, 55, 42),
        reviewed=False,
    ...
    Candidate.objects.get_or_create(
        ...
        years_exp=13,
        status='accepted',
        date_applied=datetime(2018, 6, 2, 9, 55, 42),
        reviewed=True,
    ...
    Candidate.objects.get_or_create(
        ...
        years_exp=15,
        status='pending',
        date_applied=datetime(2018, 5, 5, 11, 55, 42),
        reviewed= False,
        description=''
    )
    ...
    Candidate.objects.get_or_create(
        ...
        years_exp=1,
        status='pending',
        date_applied=datetime(2018, 4, 30, 21, 55, 42),
        reviewed=False,
